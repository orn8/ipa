...
4. You might get an error saying "*An unknown error occured while installing this app.*" when installing some apps in TrollApps. This is a false-positive and can be ignored.
