...
4. You might get an error saying "*An unknown error occured while installing this app.*" while installing some apps in TrollApps. This is a false-positive and can be ignored. Click [here](https://github.com/orn8/ipa/issues/1) to learn more.
